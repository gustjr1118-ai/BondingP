...
export async function POST(request: Request) {
  ...
  try {
    ...
    const response = await client.models.generateContent({
      ...
      contents: buildModelInput(parsed.data.request, parsed.data.questions, parsed.data.answers, parsed.data.mode),
      config: {
    ...
    return NextResponse.json(normalizeModelOutput(result, parsed.data.mode));
  } catch (error) {
